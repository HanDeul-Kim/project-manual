...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__ikea.glb'.replace('__URL__', '');
    if (!sceneURL) {
...
function prepareExternalInterface(app) {
    ...
    // app.ExternalInterface.open_in_frame = function(url) {

        
    //     $('#f1').attr('src', "assets/taellbyn-table-lamp__AA-2181871-4_pub.pdf#scrollbar=0&view=FitV&toolbar=0&page="+url);
    //     document.getElementById('f1').contentDocument.location.reload(true)
